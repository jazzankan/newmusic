    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="links p-6">
                    <p><a class="text-blue-800 text-xl" target="_blank" href="/artists">Artister hos Spotify</a></p>
                    <p><a class="text-blue-800 text-xl" target="_blank" href="/artists/create">Skapa artist</a></p>
